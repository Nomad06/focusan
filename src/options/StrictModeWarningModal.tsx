          ...
          <div className="p-6 space-y-4">
            <div className="space-y-3 text-sumi-black/80 text-sm leading-relaxed">
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li>
                  You will <strong>NOT</strong> be able to disable this mode easily.
                </li>
                <li>You cannot remove blocked sites while this mode is active.</li>
                <li>You cannot weaken schedules or delete rules.</li>
                <li>
                  Disabling this mode may require a mandatory waiting period or verification payment
                  (experimental).
                </li>
              </ul>
            </div>
            ...
            <div className="pt-4 border-t border-gray-100">
              <label className="flex items-start gap-3 cursor-pointer p-2 hover:bg-gray-50 rounded-lg transition-colors">
                <div
                  className={`mt-0.5 w-5 h-5 rounded border flex items-center justify-center transition-colors ${agreed ? 'bg-red-600 border-red-600' : 'border-gray-300 bg-white'}`}
                >
