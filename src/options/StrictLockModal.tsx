              ...
              <>
                ...
                <div className="bg-bg-2 p-4 rounded-lg border border-border">
                  <p className="text-sm text-muted mb-2">
                    Send <strong className="text-text">{requiredAmount} USDT (TRC20)</strong> to the
                    Burn Address below to unlock this action.
                  </p>

                  <div
                    className="bg-bg-1 p-3 rounded font-mono text-xs text-center break-all text-accent select-all cursor-pointer hover:bg-black/5 transition-colors border border-border"
                    onClick={() => navigator.clipboard.writeText(TRON_BURN_ADDRESS)}
                  >
                    {TRON_BURN_ADDRESS}
                  </div>
                  <div className="text-center text-[10px] text-muted mt-1">(Click to copy)</div>
                </div>
