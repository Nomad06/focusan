...
>
> Supported Languages: English, Russian, Spanish, German, French, Japanese, Chinese Simplified, and Portuguese.
...
- **v1.0.3** (2026-07-08):
  - Added full translation support and localizations for 6 additional languages: Spanish, German, French, Japanese, Chinese Simplified, and Portuguese.
  - Fully translated Bushidō quotes & phrases on the block page.
- **v1.0.2** (2026-06-29):
  - Restored missing i18n keys and added subdomain broadening keys.
- **v1.0.1** (2026-06-25):
  - Fixed domain parsing and subdomain wildcard matches.
- **v1.0.0** (2026-05-28):
  - Initial release.
